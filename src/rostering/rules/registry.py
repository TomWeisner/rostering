...
MIN_REALIZED_LENGTH_RULE_TEMPLATE: RuleTemplate = (MinRealizedLengthRule, 40, {})
...
BAND_SHORTFALL_RULE_TEMPLATE: RuleTemplate = (
    BandShortfallPenaltyRule,
    95,
    {
        "base": 1.25,
        "scale": 0.5,
