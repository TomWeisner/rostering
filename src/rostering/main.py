...
from rostering.input_data import build_input
...
def main():
    ...
    data = build_input(cfg, DAYS=cfg.DAYS, N=cfg.N, seed=cfg.SEED or 42)
    ...
    progress = MinimalProgress(cfg.TIME_LIMIT_SEC, cfg.LOG_SOLUTIONS_FREQUENCY_SECONDS)
